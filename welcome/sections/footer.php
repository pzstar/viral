...
<div class="welcome-upgrade-box">
    ...
    <a class="upgrade-button button button-primary" href="<?php echo esc_url(viral_upgrade_url('welcome-footer', 'viral-footer')); ?>" target="_blank"><?php esc_html_e('Upgrade Now', 'viral'); ?></a>
</div>