    ...
    class Viral_Welcome {
                ...
                <div class="viral-notice-content">
                    <p>
                        ...
                        printf(
                            ...
                            esc_html__('Great to see that you have been using Viral for some time. We hope you love it, and we would really appreciate it if you would %1$sgive us a 5 stars rating%2$s and spread your words to the world.', 'viral'),
                            '<a target="_blank" href="https://wordpress.org/support/theme/viral/reviews/?filter=5#new-post">',
                            '</a>'
                        );
                        ?>
                    </p>
        ...
        public function dismiss_button($name) {
            printf(
                ...
                esc_url(wp_nonce_url(add_query_arg('viral-hide-notice', $name), $name, 'viral_notice_nonce')),
                esc_html__('Dismiss this notice.', 'viral')
            );
        }
