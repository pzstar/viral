...
if (!class_exists('Viral_Welcome')) :
    ...
    class Viral_Welcome {
        ...
        public function __construct() {
            ...
            add_action('admin_enqueue_scripts', array($this, 'viral_welcome_styles_and_scripts'));

            add_action('wp_ajax_viral_activate_plugin', array($this, 'viral_activate_plugin'));
        }

        /** Welcome Message Notification on Theme Activation * */
        public function viral_activation_admin_notice() {
            global $pagenow;
        ...
        /** Welcome Page * */
        public function viral_welcome_screen() {
            ...
            <div class="wrap about-wrap access-wrap">
                <div class="abt-promo-wrap clearfix">
                    ...
                    <div class="promo-banner-wrap">
                        ...
                        <a href="<?php echo esc_url('https://hashthemes.com/wordpress-theme/viral-pro/?utm_source=wordpress&utm_medium=viral-welcome&utm_campaign=viral-upgrade'); ?>" target="_blank" class="button button-primary upgrade-btn"><?php echo esc_html__('Upgrade Now', 'viral'); ?></a>
                        <a class="promo-offer-text" href="<?php echo esc_url('https://hashthemes.com/wordpress-theme/viral-pro/?utm_source=wordpress&utm_medium=viral-welcome&utm_campaign=viral-upgrade'); ?>" target="_blank"><?php echo esc_html__('Unlock all the possibitlies with Viral Pro.', 'viral'); ?></a>
                    </div>
                </div>
                ...
                <div class="nav-tab-wrapper clearfix">
                    <?php foreach ($tabs as $id => $label) : ?>
                        ...
                        ?>
                        <a href="<?php echo esc_url(admin_url('themes.php?page=viral-welcome&section=' . $id)); ?>" class="<?php echo esc_attr($nav_class); ?>" >
        ...
        public function viral_check_installed_plugin($slug, $filename) {
            return file_exists(ABSPATH . 'wp-content/plugins/' . $slug . '/' . $filename . '.php') ? true : false;
        }

        // Check if plugin is activated
        public function viral_check_plugin_active_state($slug, $filename) {
        ...
        public function viral_activate_plugin() {
