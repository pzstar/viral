...
= 1.8.45 - Aug 15, 2024 =
* Pro demo added
* Excerpt showing styles code fixed
...
= 1.8.40 - Jun 19, 2024 =
* theme.json added and configured

= 1.8.39 - May 27, 2024 =
* Compatibility with Elementor container

= 1.8.38 - Apr 30, 2024 =
* Missing Translation Added
* Internal Linking of Related Contents plugin suggested as recommended plugin

= 1.8.37 - Apr 7, 2024 =
* CSS variable error for font fixed
...
= 1.8.31 - Sep 20, 2023 =
* Option to display between posted and updated date added on single and archive page
...
= 1.8.27 - Jun 22, 2023 =
* Home Page Sections notice added to find the section active states
...
= 1.8.23 - Apr 11, 2023 =
* Minor CSS fixes
* Active call back function added for Custom Font uploader
...
= 1.6.7 - Mar 17, 2021 =
* Added theme support for Gutenberg parameters
* Google font display swap added
