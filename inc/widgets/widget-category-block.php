...
add_action('widgets_init', 'viral_pro_register_category_block');

function viral_pro_register_category_block() {
    register_widget('viral_pro_category_block');
}

class Viral_Pro_Category_Block extends WP_Widget {

    public function __construct() {
        parent::__construct(
                'viral_pro_category_block', 'Viral : Category Block', array(
                'description' => __('A widget to display posts filtered by category', 'viral-pro')
                )
        );
    }
    ...
    private function widget_fields() {
        ...
        $cat = array();
        $cat[-1] = __( 'Latest Posts', 'viral-pro' );
        ...
        $fields = array(
            ...
            'category' => array(
                ...
                'viral_pro_widgets_title' => __('Select Category', 'viral-pro'),
                'viral_pro_widgets_field_type' => 'select',
                'viral_pro_widgets_field_options' => $cat
            ),
            'post_no' => array(
                'viral_pro_widgets_name' => 'post_no',
                'viral_pro_widgets_title' => __('No of Posts', 'viral-pro'),
