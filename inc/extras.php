...
function viral_pro_body_classes( $classes ) {
	...
	$website_layout = get_theme_mod('viral_pro_website_layout');
...
if( !function_exists( 'viral_pro_filter_archive_title' ) ){
	function viral_pro_filter_archive_title($title){
	    if ( is_category() ) {
	        $title = sprintf( __( '%s', 'viral-pro' ), single_cat_title( '', false ) );
	    }
	    return $title;
	}
}

add_filter('get_the_archive_title','viral_pro_filter_archive_title');

if( !function_exists( 'viral_pro_comment' ) ){
		...
		<<?php echo $tag; ?> id="comment-<?php comment_ID(); ?>" <?php comment_class( empty( $args['has_children'] )  ? 'parent' : '', $comment ); ?>>
			<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
				<footer class="comment-meta">
					...
					<p class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'viral-pro' ); ?></p>
					<?php endif; ?>
					<?php edit_comment_link( __( 'Edit', 'viral-pro' ), '<span class="edit-link">', '</span>' ); ?>
				</footer><!-- .comment-meta -->
					...
					<a href="<?php echo esc_url( get_comment_link( $comment, $args ) ); ?>">
						<time datetime="<?php comment_time( 'c' ); ?>">
							<?php
								...
								printf( __( '%1$s at %2$s', 'viral-pro' ), get_comment_date( '', $comment ), get_comment_time() );
							?>
						</time>
					</a>
...
add_filter( 'get_custom_logo', 'viral_pro_remove_itemprop' );

function viral_pro_remove_itemprop(){
...
if(!function_exists('viral_pro_font_awesome_icon_array')){
	function viral_pro_font_awesome_icon_array(){
...
if( function_exists('viral_pro_check_social_icon_exists')){
	function viral_pro_check_social_icon_exists(){
		$facebook = get_theme_mod('viral_pro_social_facebook');
		$twitter = get_theme_mod('viral_pro_social_twitter');
		$google_plus = get_theme_mod('viral_pro_social_google_plus');
		$pinterest = get_theme_mod('viral_pro_social_pinterest');
		$youtube = get_theme_mod('viral_pro_social_youtube');
		$linkedin = get_theme_mod('viral_pro_social_linkedin');
		$instagram = get_theme_mod('viral_pro_social_instagram');
...
if( !function_exists('viral_pro_social_links') ){
	function viral_pro_social_links(){
		$facebook = get_theme_mod('viral_pro_social_facebook');
		$twitter = get_theme_mod('viral_pro_social_twitter');
		$google_plus = get_theme_mod('viral_pro_social_google_plus');
		$pinterest = get_theme_mod('viral_pro_social_pinterest');
...
if( !function_exists('viral_pro_show_date') ){
	function viral_pro_show_date(){
		$viral_pro_left_header_date = get_theme_mod('viral_pro_left_header_date');
		if($viral_pro_left_header_date){ 
...
if(!function_exists('viral_pro_header_text')){
	function viral_pro_header_text(){
		$viral_pro_left_header_text = get_theme_mod('viral_pro_left_header_text');
		if($viral_pro_left_header_text){
			echo '<span>';
			echo '<i class="fa fa-bookmark" aria-hidden="true"></i>'. esc_html($viral_pro_left_header_text);
			echo '</span>';
		}
	}
}
					
if( !function_exists('viral_pro_top_menu') ){
	function viral_pro_top_menu(){
		wp_nav_menu( 
			array( 
...
add_action( 'viral_pro_right_header_content', 'viral_pro_social_links' );
add_action( 'viral_pro_left_header_content', 'viral_pro_show_date', 10 );
add_action( 'viral_pro_left_header_content', 'viral_pro_header_text', 20 );
add_action( 'viral_pro_left_header_content', 'viral_pro_top_menu', 30 );