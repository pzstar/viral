...
/** Color Tab Control */
class Viral_Box_Shadow_Control extends WP_Customize_Control {
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'box_shadow' => esc_attr__('Box Shadow', 'viral'),
            'x' => esc_attr__('X', 'viral'),
            'y' => esc_attr__('Y', 'viral'),
            'blur' => esc_attr__('Blur', 'viral'),
            'spread' => esc_attr__('Spread', 'viral'),
            'inset' => esc_attr__('Inset', 'viral'),
            'color' => esc_attr__('Color', 'viral'),
        );
        if (false === $id) {
