...
// Upgrade Text
class Viral_Upgrade_Info_Control extends WP_Customize_Control {
     ...
     * class are left alone. Set to false on an individual control to suppress it.
     */
    public $upgrade_note = '';
    ...
    public function render_content() {
        ...
        if ($this->upgrade_url && false !== $this->upgrade_note) {
            $note = $this->upgrade_note ? $this->upgrade_note : esc_html__('$69 one-time. Unlimited sites, lifetime updates, no renewal fees.', 'viral');
