...
/** Dimensions Control */
class Viral_Dimensions_Control extends WP_Customize_Control {
    ...
    public function to_json() {
        ...
        $this->json['title'] = esc_html__('Link values together', 'viral');
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'desktop_top' => esc_attr__('Top', 'viral'),
            'desktop_right' => esc_attr__('Right', 'viral'),
            'desktop_bottom' => esc_attr__('Bottom', 'viral'),
            'desktop_left' => esc_attr__('Left', 'viral'),
            'tablet_top' => esc_attr__('Top', 'viral'),
            'tablet_right' => esc_attr__('Right', 'viral'),
            'tablet_bottom' => esc_attr__('Bottom', 'viral'),
            'tablet_left' => esc_attr__('Left', 'viral'),
            'mobile_top' => esc_attr__('Top', 'viral'),
            'mobile_right' => esc_attr__('Right', 'viral'),
            'mobile_bottom' => esc_attr__('Bottom', 'viral'),
            'mobile_left' => esc_attr__('Left', 'viral'),
        );
        if (false === $id) {
