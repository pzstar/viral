 ...
 * @access public
 */
class Viral_Typography_Control extends WP_Customize_Control {
    ...
    public function enqueue() {
        wp_enqueue_script('ht--customize-typograhpy-controls', VIRAL_CUSTOMIZER_URL . 'custom-controls/typography/js/customize-controls.js', array('jquery'), VIRAL_VERSION, true);
        wp_enqueue_style('ht--customize-typograhpy-controls', VIRAL_CUSTOMIZER_URL . 'custom-controls/typography/css/customize-controls.css', array(), VIRAL_VERSION);
    }
    ...
    function get_default_font_families() {
        ...
        $default_font = viral_default_font_array();
    ...
    function get_google_font_families() {
        ...
        $google_font = viral_google_font_array();
    ...
    public function get_font_weight_choices() {
        if ($this->settings['family']->id) {
            ...
            $font_array = viral_search_key($font, 'family', $get_font_family);
    ...
    public function get_text_decoration_choices() {
        return array(
            'none' => esc_html__('None', 'viral'),
            'underline' => esc_html__('Underline', 'viral'),
            'line-through' => esc_html__('Line-through', 'viral'),
            'overline' => esc_html__('Overline', 'viral')
        );
    }
    ...
    public function get_text_transform_choices() {
        return array(
            'none' => esc_html__('None', 'viral'),
            'uppercase' => esc_html__('Uppercase', 'viral'),
            'lowercase' => esc_html__('Lowercase', 'viral'),
            'capitalize' => esc_html__('Capitalize', 'viral')
        );
    }
