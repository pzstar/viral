...
/** Background Control */
class Viral_Background_Image_Control extends WP_Customize_Control {
    ...
    public function __construct($manager, $id, $args = array()) {
        ...
        $this->button_labels = apply_filters('viral_customizer_background_button_labels', $button_labels, $id);

        // Set field labels
        $field_labels = $this->get_field_labels();
        $this->field_labels = apply_filters('viral_customizer_background_field_labels', $field_labels, $id);

        // Set background choices
        $background_choices = $this->get_background_choices();
        $this->background_choices = apply_filters('viral_customizer_background_choices', $background_choices, $id);
    }
    ...
    public static function get_button_labels() {
        ...
        $button_labels = array(
            'select' => esc_html__('Select Image', 'viral'),
            'remove' => esc_html__('Remove', 'viral'),
        );
    ...
    public static function get_field_labels() {
        ...
        $field_labels = array(
            'repeat' => esc_html__('Repeat', 'viral'),
            'size' => esc_html__('Size', 'viral'),
            'position' => esc_html__('Position', 'viral'),
            'attachment' => esc_html__('Attachment', 'viral'),
            'color' => esc_html__('Background Color', 'viral'),
            'overlay' => esc_html__('Overlay Color', 'viral')
        );
    ...
    public static function get_background_choices() {
        ...
        $choices = array(
            'repeat' => array(
                'no-repeat' => esc_html__('No Repeat', 'viral'),
                'repeat' => esc_html__('Tile', 'viral'),
                'repeat-x' => esc_html__('Tile Horizontally', 'viral'),
                'repeat-y' => esc_html__('Tile Vertically', 'viral')
            ),
            'size' => array(
                'auto' => esc_html__('Default', 'viral'),
                'cover' => esc_html__('Cover', 'viral'),
                'contain' => esc_html__('Contain', 'viral')
            ),
            'position' => array(
                'left-top' => esc_html__('Left Top', 'viral'),
                'left-center' => esc_html__('Left Center', 'viral'),
                'left-bottom' => esc_html__('Left Bottom', 'viral'),
                'right-top' => esc_html__('Right Top', 'viral'),
                'right-center' => esc_html__('Right Center', 'viral'),
                'right-bottom' => esc_html__('Right Bottom', 'viral'),
                'center-top' => esc_html__('Center Top', 'viral'),
                'center-center' => esc_html__('Center Center', 'viral'),
                'center-bottom' => esc_html__('Center Bottom', 'viral')
            ),
            'attachment' => array(
                'fixed' => esc_html__('Fixed', 'viral'),
                'scroll' => esc_html__('Scroll', 'viral')
            )
        );
