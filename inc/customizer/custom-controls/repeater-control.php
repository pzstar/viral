...
/** Repeater Control */
class Viral_Repeater_Control extends WP_Customize_Control {
                    ...
                    <div class="ht--repeater-fields">
                            ...
                            <div class="ht--fields ht--type-<?php echo esc_attr($field['type']) . ' ' . esc_attr($class); ?>">
                                ...
                                switch ($field['type']) {
                                    ...
                                    case 'upload':
                                        ...
                                        echo '<button type="button" class="button ht--delete-button align-left">' . esc_html__('Remove', 'viral') . '</button>';
                                        echo '<button type="button" class="button ht--upload-button alignright">' . esc_html__('Select Image', 'viral') . '</button>';
                                    ...
                                    case 'category':
                                        ...
                                        echo '<option value="-1" ' . selected($new_value, '-1', false) . '>' . esc_html__('Latest Posts', 'viral') . '</option>';
                        ...
                        <div class="ht--clearfix ht--repeater-footer">
                            <div class="alignright">
                                <a class="ht--repeater-field-remove" href="#remove"><?php esc_html_e('Delete', 'viral') ?></a> |
                                <a class="ht--repeater-field-close" href="#close"><?php esc_html_e('Close', 'viral') ?></a>
                            </div>
                        </div>
                    </div>
                </li>
