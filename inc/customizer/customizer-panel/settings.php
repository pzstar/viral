...
$wp_customize->add_control(
    new Viral_Upgrade_Info_Control(
        $wp_customize,
        'viral_web_layout_upgrade_text',
        array(
            'section' => 'viral_website_layout_sec',
...
$wp_customize->add_setting(
    'viral_load_google_font_locally',
    array(
        'sanitize_callback' => 'viral_sanitize_checkbox',
        'default' => false,
...
$wp_customize->add_setting(
    'viral_title_tagline_upgrade_text',
    array(
        'sanitize_callback' => 'viral_sanitize_text'
    )
);
...
$wp_customize->add_section(
    'viral_header_typography_section',
    array(
        'panel' => 'viral_typography_panel',
...
$wp_customize->add_section(
    'viral_main_header_settings_sec',
    array(
...
$wp_customize->add_setting(
    'viral_main_header_upgrade_text',
    array(
        'sanitize_callback' => 'viral_sanitize_text'
    )
);
...
$wp_customize->add_control(
    new Viral_Chosen_Select_Control(
        $wp_customize,
        'viral_ticker_category',
        array(
...
$wp_customize->add_setting(
    'viral_ticker_dark_color_scheme',
    array(
        'default' => false,
        'sanitize_callback' => 'viral_sanitize_checkbox'
    )
...
$wp_customize->add_setting(
    'viral_top_section_upgrade_text',
    array(
        'sanitize_callback' => 'viral_sanitize_text'
    )
);
...
$wp_customize->add_setting(
    'viral_middle_left_section_upgrade_text',
    array(
        'sanitize_callback' => 'viral_sanitize_text'
    )
);
...
$wp_customize->add_section(
    'viral_frontpage_middle_right_sec',
    array(
...
$wp_customize->add_setting(
    'viral_frontpage_middle_right_sec_text',
    array(
        'sanitize_callback' => 'viral_sanitize_text'
    )
);
...
$wp_customize->add_setting(
    'viral_bottom_section_upgrade_text',
    array(
        'sanitize_callback' => 'viral_sanitize_text'
    )
);
...
$wp_customize->add_setting(
    'viral_blog_display_date_option',
    array(
        'default' => 'posted',
        'sanitize_callback' => 'viral_sanitize_choices'
    )
...
$wp_customize->add_setting(
    'viral_single_post_sec_upgrade_text',
    array(
        'sanitize_callback' => 'viral_sanitize_text'
    )
);
