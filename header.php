...
<div id="vl-page">
	<header id="vl-masthead" class="vl-site-header">
		<div class="vl-top-header">
			<div class="vl-container clearfix">
				<div class="vl-top-left-header">
					...
					/*
					* Left Header Hook
					* @hooked - viral_pro_show_date - 10
					* @hooked - viral_pro_header_text - 10
					* @hooked - viral_pro_top_menu - 10
					*/
					do_action('viral_pro_left_header_content') ?>
				</div>
				...
				<div class="vl-top-right-header">
					...
					/*
					* Right Header Hook
					* @hooked - viral_pro_social_links - 10
					*/
					do_action('viral_pro_right_header_content') ?>
				</div>
			</div>
		</div>
		...
		<img src="<?php echo get_template_directory_uri(); ?>/images/shadow.png" alt="<?php esc_attr('Shadow','viral-pro'); ?>">
	</header><!-- #vl-masthead -->
