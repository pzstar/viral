...
$disable_section = get_theme_mod('viral_pro_frontpage_slider_sec2_disable', 'off');
...
<?php  
	$viral_pro_frontpage_slider_blocks = get_theme_mod('viral_pro_frontpage_slider_blocks2', json_encode(array(
        array(
            'category' => '',
            'layout' => 'style1',
            'enable' => 'on'
	...
	if($viral_pro_frontpage_slider_blocks){
		...
		foreach ($viral_pro_frontpage_slider_blocks as $viral_pro_frontpage_slider_block) {
			if($viral_pro_frontpage_slider_block->enable == 'on'){
				...
				do_action('viral_pro_slider_section2', $args);
